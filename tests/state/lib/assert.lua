-- filepath: tests/state/lib/assert.lua
--- Phase-2 R-STATE assert helpers (W2 test base). Reuses the tests/w8/chain.lua
--- check/assert_eq style but per-fixture: each fixture creates a fresh context
--- via assert_mod.new() so fixtures stay independent under the runner.
---
